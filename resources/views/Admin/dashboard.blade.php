...
<div class="row row-sm">
    <div class="col-sm-6 col-xl-3 col-lg-6">
        <div class="card custom-card">
            <div class="card-body dash1">
                <div class="d-flex">
                    <h3 class="dash-25 counter">568</h3>
                    <div class="ml-auto">
                        <i class="fe fe-aperture fa-2x"></i>
                    </div>
                </div>
                <div class="expansion-label d-flex">
                    <span class="text-muted">New Appointment</span>
                </div>
            </div>
        </div>
    </div>
    <div class="col-sm-6 col-xl-3 col-lg-6">
        <div class="card custom-card">
            <div class="card-body dash1">
                <div class="d-flex">
                    <h3 class="dash-25 counter">12897</h3>
                    <div class="ml-auto">
    ...
    <div class="col-sm-6 col-xl-3 col-lg-6">
        <div class="card custom-card">
            <div class="card-body dash1">
                <div class="d-flex">
                    <h3 class="dash-25 counter">11234</h3>
                    <div class="ml-auto">
    ...
    <div class="col-sm-6 col-xl-3 col-lg-6">
        <div class="card custom-card">
            <div class="card-body dash1">
                <div class="d-flex">
                    <h3 class="dash-25 counter">789</h3>
                    <div class="ml-auto">
